...
Since this is a public repository, you only need to download the .pbix file for it to work. [dashboards/spotify-stream-analysis.pbix](dashboards/spotify-stream-analysis.pbix)
